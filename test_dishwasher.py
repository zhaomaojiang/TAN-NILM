...
if data_set_name == 'REDD':
    ...
    batch_si = 64
folder_name = './data/REFIT_dataset/'+'refit_64dis_sam8_sen0'+'.pickle'  # todo:
stri = was_appliance[app_name]['stride']

checkpoint = torch.load('check_'+app_name+'/spexlast96.pt')

model = TAN_Plus(L1=3, N=32, B=3, O=32, P=96, Q=3, num_spks=5, spk_embed_dim=32, Head=4, causal=False).cuda()
